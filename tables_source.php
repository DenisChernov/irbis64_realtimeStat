...
class tables {
    ...
    function makeHeader_part1()
    {
        ...
        echo '<tr>
              ...
              <tr>
                 ...
                 <td colspan="2">Внест.<br>формы</td>
                 ...
                 <td colspan="2">Пользо-<br>ватели</td>
                 <td colspan="1" rowspan="3">
                     <svg width="40" height="160" class="svg-text">
              ...
              <tr>
                 ...
                 <td rowspan="2">
                         <svg width="40" height="160" class="svg-text">
                            <text x="-140" y="24" transform="rotate(-90)">Всего</text>
                         </svg>
                 </td>
                 <td rowspan="2">
                         <svg width="40" height="160" class="svg-text">
                            <text x="-140" y="24" transform="rotate(-90)">В т.ч.</text>
                         </svg>
                 </td>
                 <td rowspan="2">
                         <svg width="40" height="160" class="svg-text">
                 ...
                 <td colspan="2">Внестац.<br>формы</td>
                 <td rowspan="2">
                         <svg width="40" height="160" class="svg-text">
     ...
     */
    function fillNumbers($direction, $count, $fillCol, $incolor)
    {
        echo '<tr>';
...
//                echo '<td id="col_'. $i. "_row_". $row. " ". ($incolor === 1 ? 'bgcolor="#CCFFFF"' : ''). '>'. $i. '</td>';
                echo '<td '. ($incolor === 1 ? 'bgcolor="#CCFFFF"' : ''). '>'. $i. '</td>';
            else
                echo '<td>'. $i. '</td>';
            ...
            if ($fillCol === 1)
                for ($j = 1; $j < $count ; $j++)
                    if ($i % 2 === 0)
                        echo '<td id="col_'. $j. "_row_". $i. '" '. ($incolor === 1 ? 'bgcolor="#CCFFFF"' : ''). '>&nbsp;</td>';
                    else
                        echo '<td id="col_'. $j. "_row_". $i. '">&nbsp;</td>';
     ...
     * $caption: заголовок
     */
    function fillCaption($caption, $direction, $count)
    {
        echo '<tr>';
        for ($i = 1; $i <= $count; $i++)
        {
            ...
            echo ($i === 1 ? '<td height="64">
                                <svg width="40" height="70" class="svg-text">
                                    <text transform="rotate(-90)"><tspan x="-60" y="14">'. str_replace('_', '</tspan><tspan x="-56" y="34">', $caption). '</tspan></text></svg></td>' : '<td>&nbsp;</td>');
